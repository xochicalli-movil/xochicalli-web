...
export const updateInformation = async (values, uid) => {
...
export const updateProfilePicture = async (fileRef, uid) => {
    try {
...
export const queryDirections = async (uid) => {
    try {
...
export const getProduct = async (collectionName, id) => {
    try {
...
export const addComment = async (values, product) => {
    try {
...
export const addOrder = async (items, total, card, uid) => {
    try {
...
export const addAddress = async (values, uid) => {
    try {
        const userRef = doc(db, "users", uid);
        const valuesToAdd = {
            names: values.names,
...
export const queryData = async (col) => {
    try {
...
export const uploadImage = async (fileRef) => {
    try {
...
export const addProduct = async ({ title, description, subcategory, price, category, stock, tags }, image) => {
    try {
...
export const deleteProduct = async (id, image) => {
    try {
...
export const guardarDireccion = async (userId, direction) => {
    try {
...
export const saveCategoriasToFirebase = async (data) => {
    try {
